...
class DNNModel:
    def __init__(self, X_train=None, Y_train=None, minority_bias=1, algo="CNN", embedding="fasttext",
                 max_features=5000, maxlen=507,
